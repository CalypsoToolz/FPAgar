...
/**
 * @author G1ta0, modify by Calypso
 */

public class ExProperties extends Properties
{
	private static final Logger _log = Logger.getLogger(ExProperties.class);
	...
	public boolean getProperty(String name, boolean defaultValue)
	{
		...
		if((value = super.getProperty(name, null)) != null && !value.isEmpty())
			...
			_log.warn("[" + fileName + "] Missing value for \"" + name + "\", using default value: " + val);
